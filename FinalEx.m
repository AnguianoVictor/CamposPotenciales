...
forwardVec = [0 0 0]'; %Vector of the plane's forward direction in plane frame
rot = eye(3,3); %Initial plane rotation
pos = [52*7,303*7,130]; %Initial plane position
vel = 1000; %Velocity
